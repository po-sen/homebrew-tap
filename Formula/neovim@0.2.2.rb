class NeovimAT022 < Formula
  desc "Ambitious Vim-fork focused on extensibility and agility"
  homepage "https://neovim.io/"
  url "https://github.com/neovim/neovim/archive/refs/tags/v0.2.2.tar.gz"
  ...
  def install
    ...
    cd "deps-build" do
      system "luarocks", "build", "build/src/lpeg/lpeg-1.0.1-1.src.rock", lua_path, "--tree=."
      system "luarocks", "build", "build/src/mpack/mpack-1.0.6-0.src.rock", lua_path, "--tree=."
